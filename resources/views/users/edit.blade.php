...
<head>
  ...
  <title>Edit Data User - Hadirin</title>
  <style>
    @keyframes fadeIn {
  ...
  <div class="w-full rounded-b-3xl bg-gradient-to-br from-dark-800 to-dark-900 p-6 relative overflow-hidden">
    <div class="relative z-10 max-w-6xl mx-auto">
      ...
      <div class="flex items-center mt-6">
        <a href="{{ route('users.index') }}" class="text-gray-300 hover:text-white transition-colors mr-4">
          <i class="fas fa-arrow-left text-xl"></i>
        </a>
        <h1 class="text-xl font-bold text-white">Edit Data User</h1>
      </div>
    </div>
  </div>

  <!-- Content -->
  <div class="w-full px-4 md:px-6 pt-8 pb-6 bg-white rounded-t-3xl -mt-4 min-h-[65vh] max-w-3xl mx-auto fade-in">
    <!-- Main Card -->
    <div class="bg-white rounded-xl border border-gray-200 shadow-card overflow-hidden">
      <!-- Card Header -->
      <div class="px-6 py-4 border-b bg-gradient-to-r from-primary-700 to-primary-800">
          ...
          <div>
            ...
            <div class="relative rounded-md shadow-sm">
              ...
              <select 
                name="gender" 
                id="gender"
                class="form-select block w-full pl-10 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500"
              >
