...
<head>
  ...
  <title>Presensi Berhasil - Hadirin</title>
    ...
    <div class="bg-white rounded-xl shadow-card p-6 text-center">
      <div class="mb-6 p-4 bg-green-50 border-l-4 border-green-500 rounded-lg">
        <div class="flex flex-col items-center">
          ...
          <h2 class="text-xl font-semibold text-green-800 mb-2">{{ $message }}</h2>
        </div>
      </div>

      <div class="bg-gray-50 p-4 rounded-lg mb-6 border border-gray-200">
        <div class="grid grid-cols-2 gap-4 text-sm sm:text-base">
          <div class="font-medium text-gray-700 text-right pr-4">Nama:</div>
          <div class="text-gray-800 text-left">{{ $data['nama'] }}</div>
          
          <div class="font-medium text-gray-700 text-right pr-4">Status:</div>
          <div class="text-gray-800 text-left capitalize">{{ $data['status'] }}</div>
          
          <div class="font-medium text-gray-700 text-right pr-4">Waktu:</div>
          <div class="text-gray-800 text-left">{{ $data['waktu'] }}</div>
        </div>
      </div>

      <div class="flex justify-center">
        <a href="{{ url('/') }}" class="btn-animate px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700">
